...
function DangerSection() {
  ...
  return (
    <Section title="danger zone" subtitle="account">
      <div className="flex items-center justify-between">
        <div>
          <div className="text-[13px] text-[#e7dfd3]">Log out</div>
          <div className="text-[11px] text-[#4a4048]">Clear session and return to login screen</div>
        </div>
        <button
          onClick={logout}
          className="border-[3px] border-[#c0392b] text-[#c0392b] px-5 py-2 text-[12px] uppercase hover:bg-[#3a1520] transition-colors"
        >
          log out
        </button>
      </div>
